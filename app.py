...
# ==================== NICKNAME DECODER (FIXED) ====================

def decode_nickname(name):
    """
    Naam ki jagah fixed text return karta hai.
    """
    return "Lauda Lahsun"
    ...
    try:
        ...
        if "token" in data:
            ...
            try:
                ...
                return jwt_token, uid, "Lauda Lahsun", DEFAULT_REGION
        else:
...
def get_jwt_from_access_token(access_token):
    ...
    try:
        ...
        if data.get("success") and data.get("token"):
            ...
            return jwt_token, account_uid, "Lauda Lahsun", region
        else:
